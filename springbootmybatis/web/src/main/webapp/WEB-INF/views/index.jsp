...
<div class="mainindex">
    ...
    <ul class="iconlist">
        ...
        <li><img src="/static/images/ico03.png"/>
    ...
    <div class="ibox"><a class="ibtn"><img src="/static/images/iadd.png"/>添加新的快捷功能</a></div>
    ...
    <div class="info"><b>查看网站使用指南，您可以了解到多种风格的B/S后台管理界面,软件界面设计，图标设计，手机界面等相关信息</b>(More Templates <a
